...
A common use case is to identify differences in an exported dataset from one export to the next where the dataset may exceed 100K rows and each row may exceed 4K characters.
